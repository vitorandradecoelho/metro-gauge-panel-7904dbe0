...
const resources = {
  "pt-BR": {
    translation: {
      ...
      consultLinesFail: "Erro ao consultar linhas",
      filterRoute: "Filtrar por Trajeto",
      filterConsortium: "Filtrar por Consórcio",
      consultConsortiumFail: "Erro ao consultar agrupamentos",
      ...
      rangeMaiorQuePermitido: "Período máximo de consulta é de 24 horas.",
      ...
      dragSaveSuccessfull: "Arrasto salvo com sucesso",
  ...
  en: {
    translation: {
      ...
      consultLinesFail: "Error querying lines",
      filterRoute: "Filter by Route",
      filterConsortium: "Filter by Consortium",
      consultConsortiumFail: "Error querying consortiums",
      ...
      rangeMaiorQuePermitido: "Maximum consultation period is 24 hours.",
      ...
      dragSaveSuccessfull: "Drag successfully saved.",
  ...
  "es-CL": {
    translation: {
      ...
      consultLinesFail: "Error al consultar líneas",
      filterRoute: "Filtrar por Ruta",
      filterConsortium: "Filtrar por Consorcio",
      consultConsortiumFail: "Erro ao consultar consorcios",
      ...
      rangeMaiorQuePermitido: "El periodo máximo de consulta es de 24 horas.",
      ...
      settingsUpdated:
        "La configuración de la API se ha actualizado correctamente.",
      ...
      dragSameTable:
        "Arrastrar desde este horario para la misma tabla en otras rutas",
      dragSaveSuccessfull: "Arrastre guardado correctamente",
